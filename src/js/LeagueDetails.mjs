...
function leagueCardTemplate(element) {
  return `<div class="league-container" data-id="${element.league.id}">
              ...
              <img src="https://media.api-sports.io/football/leagues/${element.league.id}.png" alt="${element.league.name} - ${element.country.name}" loading="lazy" loading="lazy" onerror="this.src='/images/onerror.png';">
...
function leagueTableElements(element) {
  return `<tr>
            ...
            <div class="containerName"><img src="https://media.api-sports.io/football/leagues/${element.league.id}.png" alt="${element.league.name} - ${element.country.name}" loading="lazy" class="tableImg" onerror="this.src='/images/onerror.png';"><span>${element.league.name}</span></div></td>
...
function leagueTitle(list, parentElement) {
  const leagueTitleH2 = `<h2><div class="imgLeagueInfo"><img src="https://media.api-sports.io/football/leagues/${list[0].league.id}.png" alt="${list[0].league.name} - ${list[0].league.country}" loading="lazy" onerror="this.src='/images/onerror.png';"></div>${list[0].league.name} - ${list[0].league.country}</h2>`;
